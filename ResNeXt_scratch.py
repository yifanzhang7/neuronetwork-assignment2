...
def main():
    ...
    for epoch in range(num_epochs):
        ...
        if val_acc > best_acc:
            best_acc = val_acc
            torch.save(model.state_dict(), 'checkpoints/best_resnext50_cifar10_from_scratch.pth')
    ...
    # 计算并保存混淆矩阵
    model.load_state_dict(torch.load('checkpoints/best_resnext50_cifar10_from_scratch.pth'))
